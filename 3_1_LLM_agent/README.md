...
Unit-тесты автоматически запускаются в GitHub Actions при каждом `push` и при
создании или обновлении pull request. Отчёт о покрытии выводится в журнал запуска.
